...
class LoggingManager:
    ...
    def log_task_start(self, audit_id: int, task_name: str, task_id: str = None, 
                      context: Dict[str, Any] = None, worker_id: str = None):
    ...
    def log_task_end(self, audit_id: int, task_name: str, task_id: str = None,
                    duration_ms: float = None, context: Dict[str, Any] = None,
                    success: bool = True):
    ...
    def log_audit_event(self, audit_id: int, level: str, message: str,
                       context: Dict[str, Any] = None, task_name: str = None):
    ...
    def log_system_event(self, system: str, level: str, message: str,
...
class TaskLogger:
    ...
    def __init__(self, audit_id: int, task_name: str, task_id: str = None,
                 context: Dict[str, Any] = None):
